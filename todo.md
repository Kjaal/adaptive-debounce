...
- [x] `FRAMEWORK-003` Defer Vue automatic startup until the root mounts, preserving deterministic hydration with opted-in persisted timing and asynchronous startup; verify one app-owned observer and cleanup. Resolves `HV-ADAPTIVE-DEBOUNCE-VUE-PREMOUNT-PERSISTENCE`.
